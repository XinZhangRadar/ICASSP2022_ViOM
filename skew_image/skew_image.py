...
if __name__ == '__main__':
    #img = cv.imread("/home/zhangxin/faster-rcnn.pytorch/skew_image/163.jpg");
    for filename in os.listdir(r"/home/zhangxin/faster-rcnn.pytorch/skew_image/"):
